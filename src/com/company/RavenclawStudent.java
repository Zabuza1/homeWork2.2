...
public class RavenclawStudent extends HogwartsStudent{
    ...
    public void compareRavenclaw (RavenclawStudent ravenclawStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Student %s better than student %s%n", getName(), ravenclawStudent.getName());
        }else if (ability2 > ability1) {
            System.out.printf("Student %s better than student %s%n", ravenclawStudent.getName(), getName());
        }else {
            System.out.printf("Student %s same as student %s%n", ravenclawStudent.getName(), getName());
